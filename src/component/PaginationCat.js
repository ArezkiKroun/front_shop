...
import image from './../image/categorie.png';
...
//Supprimer la catégorie séléctioner
...
//Filtre de recherche
  ...
  return (
    ...
    <TableContainer component={Paper}>
      ...
      <h2 className="text-center m-4" style={{width:'90%'}}>Liste des Categories </h2>
     ...
     <br></br>
      ...
      <Table sx={{ minWidth: 500 }} aria-label="custom pagination table">
        ...
        <TableBody>
         {(rowsPerPage > 0
            ? filtreedcategorie.sort((a, b) => a.title > b.title ? 1 : -1).slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
            : data
          ).map((row,index) => (
            <TableRow key={index}>
